import { i as Interval, t as BasicType } from "./types-BE4PFAIb.js";
...
import { i as ResolveToValueSync, n as ResolveToValue } from "./resolve-core-Cs9xhh5G.js";
import { n as sleep } from "./sleep-aOD7WyQT.js";
import { n as SimpleEventEmitter } from "./index-CWTNd_9a.js";
import { d as LogSet } from "./index-DfS-Jl_W.js";
import { t as state_machine_d_exports } from "./state-machine-Cso9ri9w.js";
 ...
 */
declare function debounce<T extends AnyFn>(callback: T, interval: Interval, onResult?: (result: Result<ReturnType<T>, any>) => void): (...args: Parameters<T>) => void;
 ...
 * @param options Options
 */
declare function retryFunction<T>(callback: () => Promise<T | undefined>, options?: Partial<RetryOpts<T>>): Promise<RetryResult<T>>;
/**
 ...
 * @param opts
 */
declare function retryTask<V>(task: RetryTask<V>, opts?: Partial<RetryOpts<V>>): Promise<RetryResult<V>>;
//#endregion
...
declare namespace index_d_exports {
  export { AnyFn, AsyncPromiseOrGenerator, AsyncTask, AsyncTaskResult, AsyncTaskVoid, BackoffOptions, BtNode, BtNodeBase, CompletionTimer, Continuously, ContinuouslyAsyncCallback, ContinuouslyOpts, ContinuouslySyncCallback, DelayOpts, Dispatch, DispatchList, ExpressionOrResult, FullPolicy, HasCompletion, HasCompletionRunStates, ModulationTimer, MovingAverageTimedOptions, OnStartCalled, Pool, PoolOptions, PoolState, PoolUser, PoolUserEventMap, RateMinimumOptions, RelativeTimerOpts, RepeatDelayOpts, RepeatOpts, RequestResponseMatch, RequestResponseMatchEvents, RequestResponseOptions, Resource, RetryOpts, RetryResult, RetryTask, RunOpts, RunSingleOpts, SelNode, SeqNode, state_machine_d_exports as StateMachine, SyncWait, Task, TaskQueueEvents, TaskQueueMutable, TaskState, Timeout, TimeoutAsyncCallback, TimeoutSyncCallback, Timer, TimerOpts, TimerSource, Traversal, UpdateFailPolicy, WaitForValue, backoffGenerator, continuously, create, debounce, delay, delayLoop, elapsedMillisecondsAbsolute, elapsedTicksAbsolute, eventRace, everyNth, frequencyTimer, hasElapsed, iterateBreadth, iterateDepth, movingAverageTimed, ofTotal, ofTotalTicks, promiseWithResolvers, rateMinimum, relative, repeat, repeatSync, retryFunction, retryTask, run, runOnce, runSingle, singleItem, sleep, throttle, timeout, timerAlwaysDone, timerNeverDone, timerWithFunction, updateOutdated, waitFor };
}
//#endregion
export { FullPolicy as $, AsyncTaskResult as A, iterateBreadth as At, backoffGenerator as B, timerWithFunction as C, BtNode as Ct, timeout as D, Task as Dt, TimeoutSyncCallback as E, SeqNode as Et, runOnce as F, RequestResponseOptions as G, retryTask as H, BackoffOptions as I, repeat as J, RepeatDelayOpts as K, RetryOpts as L, TaskQueueEvents as M, TaskQueueMutable as N, throttle as O, TaskState as Ot, SyncWait as P, promiseWithResolvers as Q, RetryResult as R, timerNeverDone as S, delayLoop as St, TimeoutAsyncCallback as T, SelNode as Tt, RequestResponseMatch as U, retryFunction as V, RequestResponseMatchEvents as W, RateMinimumOptions as X, repeatSync as Y, rateMinimum as Z, hasElapsed as _, DispatchList as _t, UpdateFailPolicy as a, Resource as at, relative as b, DelayOpts as bt, CompletionTimer as c, movingAverageTimed as ct, Timer as d, RunOpts as dt, Pool as et, TimerOpts as f, RunSingleOpts as ft, frequencyTimer as g, Dispatch as gt, elapsedTicksAbsolute as h, everyNth as ht, singleItem as i, PoolUserEventMap as it, AsyncTaskVoid as j, iterateDepth as jt, AsyncTask as k, Traversal as kt, ModulationTimer as l, eventRace as lt, elapsedMillisecondsAbsolute as m, runSingle as mt, waitFor as n, PoolState as nt, updateOutdated as o, create as ot, TimerSource as p, run as pt, RepeatOpts as q, WaitForValue as r, PoolUser as rt, AsyncPromiseOrGenerator as s, MovingAverageTimedOptions as st, index_d_exports as t, PoolOptions as tt, RelativeTimerOpts as u, ExpressionOrResult as ut, ofTotal as v, AnyFn as vt, Timeout as w, BtNodeBase as wt, timerAlwaysDone as x, delay as xt, ofTotalTicks as y, debounce as yt, RetryTask as z };
//# sourceMappingURL=index-DJQ33JLw.d.ts.map