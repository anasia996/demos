 ...
 * Recursive.
 */
type RecursiveReplace<TShape, TFieldValue> = { [P in keyof TShape]: TShape[P] extends Array<infer U> ? Array<RecursiveReplace<U, TFieldValue>> : TShape[P] extends number | string | symbol | undefined ? TFieldValue : RecursiveReplace<TShape[P], TFieldValue> };
type PartialBy<T, K extends keyof T> = Omit<T, K> & Partial<Pick<T, K>>;
/**
 * A type where every property is partial (recursive)
 */
type RecursivePartial<T> = { [P in keyof T]?: T[P] extends Array<infer U> ? Array<RecursivePartial<U>> : T[P] extends object | undefined ? RecursivePartial<T[P]> : T[P] };
...
//#endregion
export { RecursiveWriteable as a, Rest as c, RecursiveReplace as i, Writeable as l, ReadonlyRemapObjectPropertyType as n, RemapObjectPropertyType as o, RecursivePartial as r, RequireOnlyOne as s, PartialBy as t };
//# sourceMappingURL=ts-utility-q8tixyWv.d.ts.map