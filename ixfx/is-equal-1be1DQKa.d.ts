 ...
 */
declare function isEqualValueDefault<T>(a: T, b: T): boolean;
/**
 ...
 * @returns
 */
declare function isEqualValuePartial(a: Record<string, unknown>, b: Record<string, unknown>, fieldComparer?: IsEqual<unknown>): boolean;
/**
 ...
 */
declare function isEqualValueIgnoreOrder<T>(a: T, b: T): boolean;
/**
...
//#endregion
export { isEqualDefault as a, isEqualValuePartial as c, isEqualContextString as i, IsEqualContext as n, isEqualValueDefault as o, isEmptyEntries as r, isEqualValueIgnoreOrder as s, IsEqual as t };
//# sourceMappingURL=is-equal-1be1DQKa.d.ts.map