...
const logColours = getOrGenerateSync(/* @__PURE__ */ new Map(), () => {
	return `hsl(${++logColourCount * 137.508},50%,75%)`;
});
...
//#endregion
export { logSet as a, logColours as i, getErrorMessage as n, logger as o, fpsCounter as r, resolveLogOption as s, src_exports as t };
//# sourceMappingURL=src-Bse4esd3.js.map