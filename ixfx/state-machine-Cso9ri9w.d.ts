...
import { i as LogOption } from "./index-DfS-Jl_W.js";
 ...
 */
declare function cloneState<V extends Transitions>(toClone: MachineState<V>): MachineState<V>;
/**
 ...
 */
declare function init<V extends Transitions>(stateMachine: Machine<V> | Transitions | TransitionsStrict, initialState?: StateNames<V>): MachineState<V>;
declare function reset<V extends Transitions>(sm: MachineState<V>): MachineState<V>;
declare function validateMachine<V extends Transitions>(smOrTransitions: Machine<V> | Transitions | TransitionsStrict): [machine: Machine<V> | undefined, msg: string];
/**
 * Returns _true_ if MachineState `sm` is in its final state.
 * @param sm
 */
declare function isDone<V extends Transitions>(sm: MachineState<V>): boolean;
/**
 * Returns a list of possible state targets for `sm`, or
 * an empty list if no transitions are possible.
 * @param sm
 */
declare function possibleTargets<V extends Transitions>(sm: MachineState<V>): ReadonlyArray<StateTargetStrict<V>>;
/**
 ...
 * @param sm
 */
declare function possible<V extends Transitions>(sm: MachineState<V>): Array<StateNames<V> | null>;
declare function normaliseTargets<V extends Transitions>(targets: StateTarget<V> | ReadonlyArray<StateTargetStrict<V>> | StateTargetStrict<V>): Array<StateTargetStrict<V>> | null | undefined;
/**
 ...
 * @param toState
 */
declare function to<V extends Transitions>(sm: MachineState<V>, toState: StateNames<V>): MachineState<V>;
declare function next<V extends Transitions>(sm: MachineState<V>): MachineState<V>;
/**
 * Returns _true_ if `toState` is a valid transition from current state of `sm`
 * @param sm
 * @param toState
 */
declare function isValidTransition<V extends Transitions>(sm: MachineState<V>, toState: StateNames<V>): boolean;
declare function validateTransition<V extends Transitions>(sm: MachineState<V>, toState: StateNames<V>): void;
/**
 ...
 */
declare function fromList(...states: readonly string[]): Transitions;
/**
 ...
 * @param states
 */
declare function fromListBidirectional(...states: readonly string[]): Transitions;
//#endregion
...
//# sourceMappingURL=state-machine-Cso9ri9w.d.ts.map