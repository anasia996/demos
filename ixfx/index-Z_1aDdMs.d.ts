import { t as PartialBy } from "./ts-utility-q8tixyWv.js";
...
declare function ensureLength<V>(data: readonly V[] | V[], length: number, expand?: `undefined`, truncate?: `from-end` | `from-start`): Array<V | undefined>;
//#endregion
 ...
 */
declare function sortByNumericProperty<V, K extends keyof V>(data: readonly V[] | V[], propertyName: K): V[];
/**
 ...
 */
declare function sortByProperty<V, K extends keyof V>(data: readonly V[] | V[], propertyName: K, comparer?: (a: any, b: any) => number): V[];
//#endregion
...
//#endregion
export { chunks as $, MovingWindowOptions as A, filterWithIndex as B, shuffle as C, movingWindowWithContext as D, movingWindow as E, FrequencyByGroup as F, isEqualIgnoreOrder as G, findIndexReverse as H, mapWithEmptyFallback as I, cycle as J, IsEqual as K, flatten as L, interleave as M, insertAt as N, mergeByKey as O, groupBy as P, compareTo as Q, filterAB as R, randomIndex as S, pairwiseReduce as T, containsIdenticalValues as U, findIndex as V, isEqual as W, containsDuplicateInstances as X, contains as Y, containsDuplicateValues as Z, sortByProperty as _, withoutUndefined as a, removeByFilter as b, unique as c, StepLoopLogic as d, atWrap as et, StepOptions as f, sortByNumericProperty as g, step as h, without as i, intersection as j, MergeReconcile as k, StepArrayContext as l, arrayIndexStepper as m, ZippedTuple as n, takeFromGenerator as o, StepState as p, ensureLength as q, zip as r, until as s, index_d_exports as t, StepContext as u, sample as v, pairwise as w, randomElement as x, remove as y, filterBetween as z };
//# sourceMappingURL=index-Z_1aDdMs.d.ts.map