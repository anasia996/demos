...
import { i as Interval, o as Primitive, s as PrimitiveOrObject } from "./types-BE4PFAIb.js";
import { d as ReactiveInitial, f as ReactiveNonInitial, n as ResolveToValue, u as Reactive } from "./resolve-core-Cs9xhh5G.js";
...
type Since = {
  (): number;
  _type: `since` | `once` | `infinity` | `interval`;
};
type ElapsedOptions = {
  skip: number;
};
 ...
 * @returns Since
 */
declare function elapsedSince(options?: Partial<ElapsedOptions>): Since;
/**
 ...
 * @returns Since
 */
declare function elapsedInterval(): Since;
/**
 ...
 * @returns Since
 */
declare function elapsedOnce(): Since;
/**
 ...
 */
declare function elapsedInfinity(): Since;
/**
 ...
 */
declare function toStringDefault<V>(itemToMakeStringFor: V): string;
/**
 ...
 * @returns
 */
declare function defaultToString(value: null | boolean | string | object): string;
/**
 ...
 */
declare function toStringOrdered(itemToMakeStringFor: unknown): string;
//#endregion
...
//#endregion
export { elapsedInterval as A, alignById as B, isPrimitiveOrObject as C, ElapsedOptions as D, filterValue as E, defaultKeyer as F, AlignOpts as I, DataWithId as L, elapsedSince as M, isInfiniteSince as N, Since as O, isSince as P, Similarity as R, isPrimitive as S, isEqualTrace as T, elapsedToHumanString as _, ResolvedObject as a, isInterval as b, hasLast as c, runningiOS as d, defaultToString as f, toStringOrdered as g, toStringDefault as h, parseUrlParameters as i, elapsedOnce as j, elapsedInfinity as k, isReactive as l, isSet as m, ArrayLengthMutationKeys as n, resolveFields as o, isMap as p, FixedLengthArray as r, resolveFieldsSync as s, ArrayItems as t, promiseFromEvent as u, intervalToMs as v, isInteger as w, compareIterableValuesShallow as x, isDateObject as y, align as z };
//# sourceMappingURL=types-array-DAwgAhSE.d.ts.map