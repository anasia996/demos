 ...
 * @returns
 */
declare function numericComparer(a: number, b: number): CompareResult;
/**
 ...
 * @returns
 */
declare function jsComparer(x: any, y: any): CompareResult;
/**
 * Inverts the source comparer.
 * @param comparer
 * @returns
 */
declare function comparerInverse<V>(comparer: Comparer<V>): Comparer<V>;
/**
 ...
 * @returns
 */
declare function defaultComparer(x: any, y: any): CompareResult;
//#endregion
export { jsComparer as a, defaultComparer as i, Comparer as n, numericComparer as o, comparerInverse as r, CompareResult as t };
//# sourceMappingURL=comparers-DjWD56WI.d.ts.map