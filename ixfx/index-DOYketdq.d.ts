...
//#endregion
//#region ../packages/random/src/noise.d.ts
 ...
 */
declare function noise2d(fn: NoiseKind, randomSource?: RandomSource): Promise<NoiseFunction2d>;
/**
...
declare namespace index_d_exports {
  export { GenerateRandomOptions, LfsrOptions, LfsrResult, NoiseFunction2d, NoiseKind, RandomBooleanOptions, RandomNumberOptions, RandomOptions, RandomSource, StringOptions, WeightedOptions, bipolar, bipolarSource, calculateNonZero, chance, float, floatSource, gaussian, gaussianSource, integer, integerSource, integerUniqueGen, lfsrCompute, lfsrSource, mersenneTwister, minutesMs, minutesMsSource, mulberrySource, noise2d, randomElement, randomElementWeightedSource, randomIndex, randomPluck, secondsMs, secondsMsSource, shortGuid, shuffle, string, weighted, weightedIndex, weightedInteger, weightedIntegerSource, weightedSource };
}
//#endregion
export { float as A, RandomNumberOptions as B, integerSource as C, gaussianSource as D, gaussian as E, randomIndex as F, RandomSource as H, randomPluck as I, shuffle as L, chance as M, randomElement as N, bipolar as O, randomElementWeightedSource as P, GenerateRandomOptions as R, integer as S, shortGuid as T, StringOptions as U, RandomOptions as V, WeightedOptions as W, mulberrySource as _, weightedIntegerSource as a, lfsrCompute as b, minutesMsSource as c, string as d, mersenneTwister as f, noise2d as g, NoiseKind as h, weightedInteger as i, floatSource as j, bipolarSource as k, secondsMs as l, NoiseFunction2d as m, weighted as n, weightedIndex as o, calculateNonZero as p, weightedSource as r, minutesMs as s, index_d_exports as t, secondsMsSource as u, LfsrOptions as v, integerUniqueGen as w, lfsrSource as x, LfsrResult as y, RandomBooleanOptions as z };
//# sourceMappingURL=index-DOYketdq.d.ts.map